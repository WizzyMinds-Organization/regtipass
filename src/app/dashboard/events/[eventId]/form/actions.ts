...
export async function createFormField(
  eventId: string,
  input: { label: string; field_type: FieldType; required: boolean; options: string[] | null }
): Promise<FormField> {
...
export async function updateFormField(
  eventId: string,
  fieldId: string,
  patch: Partial<{ label: string; field_type: FieldType; required: boolean; options: string[] | null }>
